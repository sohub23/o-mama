      ...
      <div className="pt-20 sm:pt-32 pb-12 sm:pb-24 bg-gradient-to-b from-background to-secondary/20">
        <div className="container mx-auto px-4 sm:px-6 max-w-4xl">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4 px-2">Privacy Policy</h1>
          ...
          <div className="bg-card rounded-xl sm:rounded-2xl p-4 sm:p-8 md:p-12 shadow-lg space-y-6 sm:space-y-8">
            <section>
              <h2 className="text-lg sm:text-2xl font-bold mb-3 sm:mb-4">1. Information We Collect</h2>
            ...
            <section>
              <h2 className="text-lg sm:text-2xl font-bold mb-3 sm:mb-4">2. How We Use Your Information</h2>
            ...
            <section>
              <h2 className="text-lg sm:text-2xl font-bold mb-3 sm:mb-4">3. Information Sharing</h2>
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-lg sm:text-2xl font-bold mb-3 sm:mb-4">4. Data Security</h2>
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-lg sm:text-2xl font-bold mb-3 sm:mb-4">5. Your Rights</h2>
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
